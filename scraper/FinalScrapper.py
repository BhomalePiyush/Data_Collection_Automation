...
client = boto3.client('kinesis')    # Global kinesis client
...
def Scraper(base_url):
   ...
   while next_page!="":
       ...
       try:
           next_page=soup.find('a',{'class':'s-pagination-item s-pagination-next s-pagination-button s-pagination-separator'}).text
